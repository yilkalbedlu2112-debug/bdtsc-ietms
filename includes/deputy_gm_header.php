...
<head>
    ...
    <title>Deputy GM Dashboard - BDTSC</title>
    ...
    <div class="row g-0">
        <div class="col-auto p-0 sidebar" id="sidebar">
            <div class="brand">
                ...
                <small class="text-light opacity-75">Deputy GM (Technical)</small>
            </div>
            <?php
            $profile_image_path = __DIR__ . '/../assets/images/Bahr dar Textile.png';
            $profile_image_src = file_exists($profile_image_path) ? '../assets/images/Bahr dar Textile.png' : 'https://via.placeholder.com/100/0f172a/ffffff?text=Deputy+GM';
            ?>
            ...
            <a href="../admin/manage_departments.php"><i class="bi bi-building"></i> Departments</a>
            <a href="../admin/audit_trail.php"><i class="bi bi-shield-check"></i> Audit Trail</a>
            <a href="../admin/reports.php"><i class="bi bi-graph-up"></i> Reports</a>
            <hr>
